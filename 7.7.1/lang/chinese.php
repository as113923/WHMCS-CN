 ...
 * @by FYWL AS113923-whmcs7.7.1-CN
 */
...
$_LANG['cartdomainsnohosting'] = "没有虚拟主机服务！点击添加";
...
$_LANG['clientareacancelconfirmation'] = "您的取消请求已经被提交。如果您的这个请求是错误的，请立刻提交工单通知我们，否则您的账户可能会被删除。";
...
$_LANG['cancelrequestdomaindesc'] = "您还拥有与此产品相关的域名的有效域名注册<br />该域名将以 %s 为单位续订,%s年的成本为 %s<br /><br />如果您愿意 想要取消域名，并让它在当前注册结束时到期，然后只需勾选下面的框。";
...
$_LANG['markdown']['columnOne']= "第1栏";
$_LANG['markdown']['columnTwo']= "第2栏";
$_LANG['markdown']['columnThree']= "第3栏";
...
$_LANG['pricingCycleShort']['biennially'] = "需2年";
$_LANG['pricingCycleShort']['triennially'] = "需3年";
...
$_LANG['domainGracePeriodFeeInvoiceItem']= "宽限期内的域名续期费用：domainName";
$_LANG['domainRedemptionPeriodFeeInvoiceItem']= "赎回宽限期内的域名续期费用：domainName";
$_LANG['gracePeriod']= "宽限期";
$_LANG['redemptionPeriod']= "赎回期";
$_LANG['domainsExpiringSoon']= "即将到期";
$_LANG['expiresToday']= "今日过期";
$_LANG['clientareagrace']= "宽限期（已过期）";
$_LANG['clientarearedemption']= "赎回期（已过期）";
$_LANG['domainRenewal']['availablePeriods']= "可用续订期";
$_LANG['domainRenewal']['unavailable']= "域名续期不可用";
$_LANG['domainRenewal']['renewingDomains']= "续订你的域名";
$_LANG['domainRenewal']['graceFee']= "宽限期费";
$_LANG['domainRenewal']['redemptionFee']= "赎回期费";
$_LANG['domainRenewal']['graceRenewalPeriodDescription']= "域名在到期时进入宽限期。一旦处于此状态，域名只能续订最长注册期限。";
$_LANG['domainRenewal']['hasExpired']= "此域名已过期。";
$_LANG['domainRenewal']['expiringIn']= "到期时间：天数";
$_LANG['domainRenewal']['expiredDaysAgo']= "已过期：几天前";
$_LANG['domainRenewal']['noDomains']= "您目前没有任何有资格续订的域名";
$_LANG['domainRenewal']['showingDomains']= "显示：显示：totalCount domains";
$_LANG['domainRenewal']['showAll']= "全部显示";
$_LANG['domainRenewal']['maximumAdvanceRenewal']= "最高提前续约是：天数";

$_LANG['navMarketConnectService']['sitelock']= "网站安全";
$_LANG['store']['sitelock']['title']= "SiteLock网站安全";
$_LANG['store']['sitelock']['tagline']= "自动扫描您的网站以查找恶意软件并保护在线声誉";
$_LANG['store']['sitelock']['manageService']= "管理您的SiteLock服务";
$_LANG['store']['sitelock']['cartShortDescription']= "SiteLock提供了一系列旨在保护您的网站和您的企业声誉的功能。";

$_LANG['learnmore']= "了解更多";
$_LANG['category']= "类别";
$_LANG['changeCurrency']= "更改货币";

$_LANG['store']['ssl']['competitiveUpgrade']= "竞争升级";
$_LANG['store']['ssl']['competitiveUpgradeBannerMsg']= "您的域<em>：域</ em>已成功验证。请选择证书类型以继续并完成结帐流程。";
$_LANG['store']['ssl']['competitiveUpgradeQualified']= "符合竞争升级资格";

$_LANG['dismiss']= "解雇";

$_LANG['store']['emailServices']['manageService']= "登录SpamExperts控制面板";
...
$_LANG['feeds']['itemsInBasket']= "你有<b>:count</b>件物品在你身上";

$_LANG['validation']['accepted']= "必须接受：属性。";
$_LANG['validation']['active_url']= "：：属性不是有效的网址。";
$_LANG['validation']['after']= "：：属性必须是日期之后的日期。";
$_LANG['validation']['alpha']= "：属性可能只包含字母。";
$_LANG['validation']['alpha_dash']= "：：属性可能只包含字母，数字和短划线。";
$_LANG['validation']['alpha_num']= "：：属性只能包含字母和数字。";
$_LANG['validation']['array']= "：属性必须是数组。";
$_LANG['validation']['before']= "：：属性必须是日期之前：日期。";
$_LANG['validation']['between']['numeric']= "：属性必须介于：min和：max。”之间";
$_LANG['validation']['between']['file']= " 属性必须介于：min和：max kilobytes之间。";
$_LANG['validation']['between']['string']= "：属性必须介于：min和：max characters之间。";
$_LANG['validation']['between']['array']= "：属性必须介于：min和：max items。";
$_LANG['validation']['boolean']= "：属性字段必须为true或false。";
$_LANG['validation']['confirmed']= "：属性确认不匹配。";
$_LANG['validation']['date']= "：属性不是有效日期。";
$_LANG['validation']['date_format']= "：：属性与格式不匹配：格式。";
$_LANG['validation']['different']= "：属性和：其他必须不同。";
$_LANG['validation']['digits']= "：属性必须是：位数。";
$_LANG['validation']['digits_between']= "：属性必须介于：min和：max digits。";
$_LANG['validation']['email']= "：：属性必须是有效的电子邮件地址。";
$_LANG['validation']['exists']= "所选：属性无效。";
$_LANG['validation']['filled']= "：属性字段是必需的。";
$_LANG['validation']['image']= "：属性必须是图像。";
$_LANG['validation']['in']= "所选：属性无效。";
$_LANG['validation']['integer']= "：属性必须是整数。";
$_LANG['validation']['ip']= "：属性必须是有效的IP地址。";
$_LANG['validation']['json']= "：：属性必须是有效的JSON字符串。";
$_LANG['validation']['max']['numeric']= "：属性可能不大于：max。";
$_LANG['validation']['max']['file']= "：属性不得大于：max kilobytes。";
$_LANG['validation']['max']['string']= "：属性不得大于：最大字符。";
$_LANG['validation']['max']['array']= "：：属性可能不超过：max items。";
$_LANG['validation']['mimes']= "：：属性必须是类型为:: values的文件。";
$_LANG['validation']['min']['numeric']= "：属性必须至少为：min。";
$_LANG['validation']['min']['file']= "：属性必须至少为：min kilobytes。";
$_LANG['validation']['min']['string']= "：属性必须至少为：min characters。";
$_LANG['validation']['min']['array']= "：属性必须至少有：min items。";
$_LANG['validation']['not_in']= "所选：属性无效。";
$_LANG['validation']['numeric']= "：属性必须是数字。";
$_LANG['validation']['present']= "：属性字段必须存在。";
$_LANG['validation']['regex']= "：属性格式无效。";
$_LANG['validation']['required']= "：属性字段是必需的。";
$_LANG['validation']['required_if']= "：：属性字段在以下情况下是必需的：其他是：value。";
$_LANG['validation']['required_unless']= "：属性字段是必需的，除非：其他是：值。";
$_LANG['validation']['required_with']= "当：值存在时，属性字段是必需的。";
$_LANG['validation']['required_with_all']= "当：值存在时，需要：属性字段。";
$_LANG['validation']['required_without']= "当：值不存在时，属性字段是必需的。";
$_LANG['validation']['required_without_all']= "当没有：值存在时，：属性字段是必需的。";
$_LANG['validation']['same']= "：属性和：其他必须匹配。";
$_LANG['validation']['size']['numeric']= "：属性必须是：size。";
$_LANG['validation']['size']['file']= "：属性必须是：size kilobytes。";
$_LANG['validation']['size']['string']= "：属性必须是：大小字符。";
$_LANG['validation']['size']['array']= "：：属性必须包含：size items。";
$_LANG['validation']['string']= "：属性必须是字符串。";
$_LANG['validation']['timezone']= "：属性必须是有效区域。";
$_LANG['validation']['unique']= "：属性已被采用。";
$_LANG['validation']['url']= "：属性格式无效。";

$_LANG['orderErrorServerHostnameInvalid']= "服务器的主机名无效。";
$_LANG['orderErrorServerNameserversInvalid']= "名称服务器前缀无效。";

$_LANG['checkAll']= "全部检查";
$_LANG['uncheckAll']= "取消全部选中";

$_LANG['maxmind']['manualReview']= "您的订单已经进行了人工审核。<br /> <br />如果您认为您错误地收到了此消息，请接受我们的道歉并<a href = \“submitticket.php \”>向我们的客户服务团队提交支持票</a>。谢谢。";

$_LANG['nodomain']= "没有指定域名";

$_LANG['store']['ssl']['cartTitle']= "使用SSL保护您的网站";
$_LANG['store']['ssl']['cartShortDescription']= "在您的网络托管中添加SSL，让访问者相信您的网站安全可靠并有助于建立信任。";

$_LANG['store']['weebly']['cartTitle']= "强大的网站建设者";
$_LANG['store']['weebly']['cartShortDescription']= "将Weebly的拖放网站构建器添加到您的主机，以便您创建一个很棒的网站，商店或博客。";

$_LANG['store']['spamexperts']['cartTitle']= "SpamExperts Email Security";
$_LANG['store']['spamexperts']['cartShortDescription']= "为您的域添加专业的电子邮件安全和存档，以保护您的电子邮件免受攻击和恶意软件的攻击。";

$_LANG['store']['sitelock']['cartTitle']= "SiteLock网站安全";

$_LANG['store']['ssl']['promo']['sidebar']['title']= "在您的网站上添加SSL";
$_LANG['store']['ssl']['promo']['sidebar']['body']= "激活挂锁图标并保护用户隐私";

$_LANG['store']['weebly']['promo']['sidebar']['title']= "强大的网站构建者";
$_LANG['store']['weebly']['promo']['sidebar']['body']= "用Weebly创建一个比以往更快的网站";
...
$_LANG['store']['sitelock']['promo']['sidebar']['body']= "自动查找恶意软件并保护您的在线声誉";

$_LANG['store']['recommendedForYou']= "推荐给你";
$_LANG['store']['lastChance']= "最后机会";

$_LANG['domains']['importantReminder']= "重要提醒";
$_LANG['domains']['irtpNotice']= "您所做的更改将启用此域的IRTP传输锁定。";
$_LANG['domains']['optOut']= "选择退出转让锁（如果有）";
$_LANG['domains']['optOutReason']= "选择退出的原因（可选）";
$_LANG['domains']['contactChangePending']= "联系人更改待定";
$_LANG['domains']['verificationRequired']= "需要验证";
$_LANG['domains']['contactsChanged']= "更改WHOIS信息的请求触发了联系验证过程。已向注册域名所有者发送电子邮件以批准更改。";
$_LANG['domains']['contactsChangedDate']= "更改WHOIS信息的请求触发了联系人验证过程。已向注册域名所有者发送电子邮件以批准更改。此操作必须在以下日期之前完成： 。";
$_LANG['domains']['newRegistration']= "已向注册域名所有者发送了一封电子邮件。必须完成验证才能避免暂停。";
$_LANG['domains']['newRegistrationDate']= "已向注册域名所有者发送了一封电子邮件。验证必须在以下日期之前完成，以避免暂停。";
$_LANG['domains']['irtpLockEnabled']= "启用IRTP传输锁定";
$_LANG['domains']['irtpLockDescription']= "由于联系人更改或新注册，此域名目前已被锁定以进行转移。";
$_LANG['domains']['irtpLockDescriptionDate']= "由于联系人更改或新注册，此域名目前已被锁定以进行转移。这将在以下日期到期。";
$_LANG['domains']['resendNotification']= "重新发送验证电子邮件";
$_LANG['domains']['resendNotificationQuestion']= "你确定要重新发送电子邮件吗？";
$_LANG['domains']['resendNotificationSuccess']= "已重新发送验证邮件。";
$_LANG['domains']['modifyPending']= "需要验证";
$_LANG['domains']['changePending']= "您所请求的更改已触发了联系人验证流程。所有权验证电子邮件已发送至：电子邮件。点击电子邮件中的链接以应用更改。";
$_LANG['domains']['changePendingDate']= "您所请求的更改已触发了联系人验证流程。所有权验证电子邮件已发送至：电子邮件。点击电子邮件中的链接：天数即可应用更改。";

$_LANG['getStartedNow']= "立即开始";
$_LANG['notificationsnew']= "新";

$_LANG['store']['websiteBuilder']['tab']['overview']= "概述";
$_LANG['store']['websiteBuilder']['tab']['features']= "功能";
$_LANG['store']['websiteBuilder']['tab']['pricing']= "定价";
$_LANG['store']['websiteBuilder']['tab']['faq']= "常见问题";
$_LANG['store']['websiteBuilder']['ddEditor']= "拖放构建器";
$_LANG['store']['websiteBuilder']['ddEditorDescription']= "简单的拖放构建器允许您创建一个不需要技术技能的专业网站。选择不同的元素来添加照片，地图或视频将它们拖放到您的网络浏览器中即可。";
$_LANG['store']['websiteBuilder']['features']['builder']= "Builder";
$_LANG['store']['websiteBuilder']['features']['builderDescription']= "用强大的拖放工具创建完美的网站";
...
$_LANG['store']['websiteBuilder']['features']['formsDescription']= "创建自定义联系表单，RSVP列表和调查";
...
$_LANG['store']['websiteBuilder']['features']['bloggingDescription']= "在几分钟内创建一个了不起的博客";
...
$_LANG['store']['websiteBuilder']['features']['seoDescription']= "强大的SEO工具，帮助搜索引擎找到你";
$_LANG['store']['websiteBuilder']['pricing']['lite']['headline']= "Try Weebly";
$_LANG['store']['websiteBuilder']['pricing']['lite']['tagline']= "创建1页网站所需的一切";
$_LANG['store']['websiteBuilder']['pricing']['idealFor']= "适合：for";
$_LANG['store']['websiteBuilder']['pricing']['siteFeatures']= "网站功能";
$_LANG['store']['websiteBuilder']['pricing']['eCommerceFeatures']= "电子商务功能";
$_LANG['store']['websiteBuilder']['pricing']['features']['ddBuilder']= "拖放构建器";
$_LANG['store']['websiteBuilder']['pricing']['features']['pages']= "无限页数";
...
$_LANG['store']['websiteBuilder']['pricing']['features']['memberCount']= "最多100个会员";
...
$_LANG['store']['websiteBuilder']['pricing']['features']['3pcFee']= "3％Weebly交易费用";
$_LANG['store']['websiteBuilder']['pricing']['features']['tenProducts']= "最多10个产品";
$_LANG['store']['websiteBuilder']['pricing']['features']['checkoutOnWeebly']= "Checkout on Weebly.com";
$_LANG['store']['websiteBuilder']['pricing']['features']['twentyFiveProducts']= "最多25个产品";
$_LANG['store']['websiteBuilder']['pricing']['features']['0pcFee']= "0％Weebly交易费用";
$_LANG['store']['websiteBuilder']['pricing']['features']['unlimitedProducts']= "无限产品";
$_LANG['store']['websiteBuilder']['pricing']['features']['checkoutDomain']= "结帐你的域名";
$_LANG['store']['websiteBuilder']['pricing']['features']['inventory']= "库存管理";
$_LANG['store']['websiteBuilder']['pricing']['features']['coupons']= "优惠券";
$_LANG['store']['websiteBuilder']['pricing']['features']['tax']= "税收计算器";
$_LANG['store']['websiteBuilder']['pricing']['features']['shipping']= "实时运费";
$_LANG['store']['websiteBuilder']['pricing']['features']['abandonedCart']= "被遗弃的购物车电子邮件";
$_LANG['store']['websiteBuilder']['pricing']['features']['giftCards']= "礼品卡";
$_LANG['store']['websiteBuilder']['adminPreview']= "你计划激活的计划将在这里显示";
$_LANG['store']['websiteBuilder']['faq']['title']= "常见问题";
$_LANG['store']['websiteBuilder']['faq']['q1']= "我可以创建博客吗？";
$_LANG['store']['websiteBuilder']['faq']['q2']= "我的网站会对移动设备友好吗？";
$_LANG['store']['websiteBuilder']['faq']['q3']= "我可以在我的网站上添加照片吗？";
$_LANG['store']['websiteBuilder']['faq']['q4']= "我可以通过我的网站销售产品吗？";
$_LANG['store']['websiteBuilder']['faq']['q5']= "我可以在我的网站上添加表单吗？";
$_LANG['store']['websiteBuilder']['faq']['q6']= "如何让我的网站进入搜索引擎？";
$_LANG['store']['websiteBuilder']['faq']['q7']= "有多种款式可供选择？";
$_LANG['store']['websiteBuilder']['faq']['q8']= "我可以升级吗？";
$_LANG['store']['websiteBuilder']['faq']['a1']= "是的，网站构建器允许您包含博客功能。";
$_LANG['store']['websiteBuilder']['faq']['a2']= "是的，所有使用Weebly网站构建器创建的网站都针对移动设备进行了优化。";
$_LANG['store']['websiteBuilder']['faq']['a3']= "是的，您可以为您的网站添加照片，但高清视频和音频仅适用于Pro＆Business计划。";
$_LANG['store']['websiteBuilder']['faq']['a4']= "是的电子商务功能包含在所有计划中，但您可以提供的产品数量各不相同。";
$_LANG['store']['websiteBuilder']['faq']['a5']= "是的，Weebly网站建设者可以轻松创建联系表格，RSVP列表，调查等。";
$_LANG['store']['websiteBuilder']['faq']['a6']= "所有Weebly供电的网站都包含强大的搜索引擎优化工具，以帮助您最大化搜索引擎排名。";
$_LANG['store']['websiteBuilder']['faq']['a7']= "是的，有多个预先制作的模板供您选择。";
$_LANG['store']['websiteBuilder']['faq']['a8']= "是的，您可以随时升级。只需登录您的帐户并选择升级选项。";
$_LANG['store']['websiteBuilder']['trust']= "全世界超过40,000,000人信任";
...
$_LANG['store']['websiteBuilder']['upgrade']['requiredDescription']= "要访问您请求的功能，您需要升级Weebly Site Builder计划。";
$_LANG['store']['websiteBuilder']['upgrade']['recommended']= "显示推荐的计划。";
...
$_LANG['store']['websiteBuilder']['upgrade']['submitTicket']= "联系支持";
$_LANG['store']['websiteBuilder']['upgrade']['to']= "升级到：产品：金额";
$_LANG['store']['websiteBuilder']['upgrade']['noPlans']= "没有找到有效的Weebly计划";
$_LANG['store']['websiteBuilder']['upgrade']['loggedInAs']= "您目前登录为：email";
$_LANG['store']['websiteBuilder']['upgrade']['switchUser']= "退出/切换用户";

$_LANG['tax']['taxLabel'] = "税号";
$_LANG['tax']['vatLabel'] = "增值税号";
$_LANG['tax']['errorInvalid'] = "提供的：taxLabel 无效";

$_LANG['fraud']['checkConfiguration'] = "欺诈检查发生错误,请联系支持部门.";
$_LANG['fraud']['title'] = "欺诈检查";
$_LANG['fraud']['error'] = "错误";
$_LANG['fraud']['manualReview'] = "您的订单已经过人工审核.<br /><br />如果您认为您错误地收到了此消息，请接受我们的歉意并<a href=\"submitticket.php\">提交支持请求 </a>致我们的客户服务团队. 谢谢.";
$_LANG['fraud']['highFraudRiskScore'] = "您的订单被标记为具有潜在的高风险，因此已经进行了人工审核.<br /><br />如果您认为您错误地收到了此消息，请接受我们的道歉并<a href=\"submitticket.php\">向我们的客户服务团队提交支持服务单</a>. 谢谢.";
$_LANG['fraud']['countryMismatch'] = "您的IP地址所在的国家/地区与您输入的帐单邮寄地址国家/地区不符，因此我们无法接受您的订单";
$_LANG['fraud']['highRiskCountry'] = "很遗憾，我们无法接受您的订单，因为您所在的国家/地区存在大量欺诈活动。 如果您想安排其他付款方式，请与我们联系.";
$_LANG['fraud']['anonymousProxy'] = "我们不允许使用匿名代理发出订单";

$_LANG['navMarketConnectService']['codeguard'] = "网站备份";
$_LANG['store']['codeguard']['cartTitle'] = "CodeGuard网站备份";
$_LANG['store']['codeguard']['cartShortDescription'] = "使用每日自动备份和一键自动恢复功能，保护您的网站免受数据丢失和攻击";
$_LANG['store']['codeGuard']['title'] = "CodeGuard备份";
$_LANG['store']['codeGuard']['headline'] = "使用每日自动备份保护<span>您的网站</ span>";
$_LANG['store']['codeGuard']['tagline'] = "使用CodeGuard网站备份，防范病毒，黑客甚至您自己的代码意外破坏您的网站.";
$_LANG['store']['codeGuard']['tab']['overview'] = "概述";
$_LANG['store']['codeGuard']['tab']['pricing'] = "定价";
$_LANG['store']['codeGuard']['tab']['features'] = "功能";
$_LANG['store']['codeGuard']['tab']['faq'] = "常见问题";
$_LANG['store']['codeGuard']['leadTitle'] = "<strong> <em>每0.65秒</ em> </ strong>，新网页感染了恶意软件。.";
$_LANG['store']['codeGuard']['leadText1'] = "通过CodeGuard的每日自动化网站备份，保护您的网站免受<strong>数据丢失和损坏</ strong>，以及来自<strong>病毒，黑客和恶意软件</ strong>的威胁.";
$_LANG['store']['codeGuard']['leadText2'] = "使用CodeGuard网站备份，您的网站每天都会备份，如果发生灾难，您可以点击以下网址将您的网站恢复到以前的某个时间点一个按钮.";
$_LANG['store']['codeGuard']['dailyBackup'] = "每日自动备份";
$_LANG['store']['codeGuard']['malwareProtection'] = "恶意软件检测和恢复";
$_LANG['store']['codeGuard']['timeMachine'] = "网站时间机器";
$_LANG['store']['codeGuard']['wpPlugin'] = "WordPress插件更新";
$_LANG['store']['codeGuard']['changeAlerts'] = "文件更改警报监控";
$_LANG['store']['codeGuard']['features']['dailyBackup'] = "每日自动网站备份";
$_LANG['store']['codeGuard']['features']['dailyBackupDescription'] = "使用内置冗余的异地自动日常备份保护您的网站。";
$_LANG['store']['codeGuard']['features']['unlimitedFiles'] = "无限的文件和数据库";
$_LANG['store']['codeGuard']['features']['unlimitedFilesDescription'] = "备份无限数量的文件和数据库 - 只受您使用的存储空间的限制。";
$_LANG['store']['codeGuard']['features']['oneClickRestore'] = "一键恢复";
$_LANG['store']['codeGuard']['features']['oneClickRestoreDescription'] = "简单的恢复过程可以轻松地将单个文件或整个网站回滚到以前的版本。";
$_LANG['store']['codeGuard']['features']['malwareMonitoring'] = "恶意软件监控";
$_LANG['store']['codeGuard']['features']['malwareMonitoringDescription'] = "轻松了解CodeGuard每天都在努力检查您的网站是否有变化。";
$_LANG['store']['codeGuard']['features']['wp'] = "自动WordPress更新";
$_LANG['store']['codeGuard']['features']['wpDescription'] = "自动更新WordPress及其插件，以便在出现问题时通过自动恢复保护其安全。";
$_LANG['store']['codeGuard']['features']['fileMonitoring'] = "文件更改监控";
$_LANG['store']['codeGuard']['features']['fileMonitoringDescription'] = "只要您网站的源代码发生变更，我们就会通过电子邮件通知您。";
$_LANG['store']['codeGuard']['features']['servers'] = "恢复的分期";
$_LANG['store']['codeGuard']['features']['serversDescription'] = "在恢复前通过简单的自动分段快速测试任何备份的网站。";
$_LANG['store']['codeGuard']['features']['email'] = "电子邮件备份";
$_LANG['store']['codeGuard']['features']['emailDescription'] = "为您的电子邮件提供保护，因为它们作为您网站文件的一部分进行备份。";
$_LANG['store']['codeGuard']['features']['api'] = "完全自动化";
$_LANG['store']['codeGuard']['features']['apiDescription'] = "如果出现问题，可通过自动通知完全免提安装和持续备份。";
$_LANG['store']['codeGuard']['chooseBackupPlan'] = "选择备份存储";
$_LANG['store']['codeGuard']['faq']['title'] = "常见问题";
$_LANG['store']['codeGuard']['faq']['q1'] = "什么是CodeGuard？";
$_LANG['store']['codeGuard']['faq']['a1'] = "CodeGuard是一个完全自动化的网站备份服务，可以为您提供全面的数据丢失和恶意软件保护。";
$_LANG['store']['codeGuard']['faq']['q2'] = "我为什么需要CodeGuard？";
$_LANG['store']['codeGuard']['faq']['a2'] = "CodeGuard为您的网站提供独立的异地备份解决方案以及日常监控，以确保您的网站免费在线和恶意软件。";
$_LANG['store']['codeGuard']['faq']['q3'] = "它是如何工作的？";
$_LANG['store']['codeGuard']['faq']['a3'] = "CodeGuard每天自动拍摄您网站的自动快照。使用这些快照，您可以将整个网站或特定文件恢复到较早的状态任何时候的版本。";
...
$_LANG['store']['codeGuard']['faq']['a5'] = "备份存储在Amazon Web Services简单存储系统上，为您的备份提供市场领先的重复性和冗余。";
$_LANG['store']['codeGuard']['faq']['q6'] = "备份是否已加密？";
$_LANG['store']['codeGuard']['faq']['a6'] = "是的，使用AES-256加密标准对备份进行加密存储。";
$_LANG['store']['codeGuard']['faq']['q7'] = "你备份数据库吗？";
$_LANG['store']['codeGuard']['faq']['a7'] = "是的，数据库也可以备份。数据库备份支持MySQL和MSSQL数据库。";
$_LANG['store']['codeGuard']['faq']['q8'] = "什么是文件更改警报监控？";
$_LANG['store']['codeGuard']['faq']['a8'] = "当您的网站发生变化时，CodeGuard可以通过电子邮件监控并通知您，以提醒您注意新的威胁和恶意软件。";
$_LANG['store']['codeGuard']['faq']['q9'] = "如果我的网站被感染会怎样？";
$_LANG['store']['codeGuard']['faq']['a9'] = "使用CodeGuard的每日快照，如果您的网站受到攻击，您可以随时恢复到以前未受感染的版本。";

$_LANG['store']['codeguard']['promo']['sidebar']['title'] = "添加网站备份";
$_LANG['store']['codeguard']['promo']['sidebar']['body'] = "使用每日自动备份保护您的网站";


$_LANG['marketConnect']['codeguard']['manage'] = "登录CodeGuard控制面板";

$_LANG['sslState']['sslInactive'] = "未检测到SSL。点击此处浏览SSL选项";
$_LANG['sslState']['sslActive'] = "检测到有效的SSL。过期：到期";
$_LANG['sslState']['sslUnknown'] = "无法验证SSL状态";
$_LANG['sslState']['validSsl'] = "检测到有效的SSL";
$_LANG['sslState']['noSsl'] = "未检测到SSL";
$_LANG['sslState']['sslInactiveService'] = "服务无效";
$_LANG['sslState']['sslInactiveDomain'] = "域无效";
$_LANG['sslState']['startDate'] = "SSL开始日期";
$_LANG['sslState']['expiryDate'] = "SSL到期日";
$_LANG['sslState']['issuerName'] ="SSL发行人名称";
